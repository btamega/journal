...
return [
    ...
    'titre-1-ParaRecommandation'=>'References System',
    'titre-2-ParaRecommandation'=>'Footnotes',
    'titre-3-ParaRecommandation'=>'Bibliography',
    'titre-4-ParaRecommandation'=>'Illustrations',
    'titre-5-ParaRecommandation'=>'Transliteration of Arabic words',
    ...
    'titre-6-ParaRecommandation'=>'Style sheet for guidance based on the Chicago Manual of Style (2016) end note',
    'titre-7-ParaRecommandation'=>'Books',
    'titre-8-ParaRecommandation'=>'references to books in footnotes',
    'titre-9-ParaRecommandation'=>'Abbreviated bibliographical  references in footnotes',
    'titre-10-ParaRecommandation'=>'Bibliography at the end of the article (in alphabetical and chronological order)',
    'titre-11-ParaRecommandation'=>'Article forming part of a collective work',
    'titre-12-ParaRecommandation'=>'References to the article in the footnotes',
    'titre-13-ParaRecommandation'=>'Reference to the short article in the footnotes',
    'titre-14-ParaRecommandation'=>'Translated works',
    'titre-15-ParaRecommandation'=>'References in footnotes',
    'titre-16-ParaRecommandation'=>'The abbreviated reference at the bottom of the page',
    'titre-17-ParaRecommandation'=>'Articles published in scientific journals',
    'titre-18-ParaRecommandation'=>'Article published in a newspaper',
    'titre-19-ParaRecommandation'=>'Book Reviews',
    'titre-20-ParaRecommandation'=>'(Ph.D) Thesis and Doctorat dissertations',
...
'titreEthique'=>'PUBLICATION ETHICS',
    'ethiqueParagraphe-1-1'=>'Hesperis-tamuda is a peer-reviewed journal. This statement regulates ethical behaviour of all parties involved in the act of publishing an article in it and is based on the COPE’s Codes of Conduct and Best Practice Guidelines ',
    ...
    'ethiqueParagraphe-2'=>'Authors should ensure that they have written entirely original works, and if the authors have used the work and/or words of others this must be appropriately cited or quoted. Such quotations and citations must be listed in the Reference at the end of the article.',
    'ethiquePublication'=>'Multiple Publication.',
    'ethiqueParagraphe-3'=>'An author should not in general publish manuscripts describing essentially the same research in more than one journal or primary publication. Submitting the same manuscript to more than one journal concurrently constitutes unethical publishing behaviour and is unacceptable.',
    'ethiqueParagraphe-4'=>'Proper acknowledgment of the work of others must always be given. Authors should cite publications that have been influential in determining the nature of the reported work.',
    'ethiqueCopyright'=>'Copyright.',
    'ethiqueParagraphe-5'=>'Hesperis-tamuda is a free open access journal licensed under the ',
    'ethiqueParagraphe-5-1'=>'Authors who publish with this journal accept the following conditions:',
    'ethiquePoint-1-1'=>'Authors retain copyright and grant the journal right of first publication, with the work simultaneously licensed under a ',
    'ethiquePoint-1-link'=>'Creative Commons Attribution License (CC BY 4.0)',
    'ethiquePoint-1-2'=>'that allows others to share the work with an acknowledgement of its authorship and initial publication in this journal.',
    'ethiquePoint-2-1'=>'Authors are free to copy and redistribute the material in any medium or format, and to remix, transform, and build upon the material, for any purpose, even commercially, with an acknowledgement of its initial publication in',
    'ethiquePoint-2-link'=>'Hesperis-Tamuda',
    'ethiquePoint-2-2'=>'(CC BY 4.0).',
    'ethiquePoint-3'=>'Authors should not post their submitted work online (e.g. in institutional repositories or on personal websites) prior to or during the submission process, as this may cause nomenclatural problems.',
    'ethiquePaternite'=>'Authorship',
    'ethiqueParagraphe-6'=>'To ensure that papers are original contributions, and to avoid copyright issues, authors must follow some rules:',
    'ethiquePoint-4'=>'When a paper is submitted, the autor means that the present paper has not been submitted to another journal, nor will it be in the futur. All co-authors are aware of the present submission.',
    'ethiquePoint-5'=>'All co-authors must be aware of and agree to the contents of the submission.',
    'ethiquePoint-6'=>'All co-authors agree with the copyright policy and the Open Access policy of the journal.',
    'ethiquePoint-7'=>'The corresponding author declares that the manuscript and the illustrations within are original, or that he/she has taken all the necessary steps to avoid breach of copyright.',
    ...
    'ethiqueParagraphe-8'=>'Corresponding author is the author responsible for communicating with the journal for publication. The corresponding author should ensure that all appropriate co-authors and no inappropriate co-authors are included on the paper. All co-authors have seen and approved the final version of the paper and have agreed to its submission for publication.',
    'ethiqueReconnaissanceFinancement'=>'Acknowledgment of Funding Sources.',
    'ethiqueParagraphe-9'=>'Sources of funding for the research reported in the article should be duly acknowledged at the end of the article.',
    'ethiqueDivulgation'=>'Disclosure and Conflicts of Interest.',
    'ethiqueParagraphe-10'=>'All authors should disclose in their manuscript any financial or other substantive conflict of interest that might be construed to influence the results or interpretation of their manuscript.',
    'ethiqueErreur'=>'Fundamental Errors in Published Works.',
    'ethiqueParagraphe-11'=>'When an author discovers a significant error or inaccuracy in his/her own published work, it is the author’s obligation to promptly notify the journal editors or publisher and cooperate with the editor to retract or correct the paper.',
    'ethiqueReviseur'=>'For Reviewers',
    'ethiqueProcessus'=>'The Hesperis-tamuda review process',
    'ethiqueParagraphe-12'=>'Papers which conform to journal scope and style will be sent to at least two reviewers by a member of the editorial team, who will then act as the coordinating editor.',
    'ethiqueParagraphe-13'=>'applies double-blind peer review, which means that reviewers remain anonymous by default. However, if reviewers want their names to be communicated to the author, Hesperis-Tamuda will allow this.',
    'ethiqueContribution'=>'Contribution of Peer Review.',
    'ethiqueParagraphe-14'=>'Peer review assists the editors in making editorial decisions while editorial communications with the author may also assist the author in improving the paper.',
    'ethiqueNonQualifie'=>'Unqualified to Review or Promptness. ',
    'ethiqueParagraphe-15'=>'Any reviewer who feels unqualified to review the assigned manuscript or unable to provide a prompt review should notify the editors and excuse himself/herself from the review process.',
    'ethiqueConfidentialite'=>'Confidentiality.',
    'ethiqueParagraphe-16'=>'Manuscripts received for review must be treated as confidential documents. They must not be shown to, or discussed with, others except as authorized by the chief editors. Privileged information or ideas obtained through peer review must be kept confidential and not used for personal advantage.',
    'ethiqueNorme'=>'Standards of Objectivity.',
    'ethiqueParagraphe-17'=>'Reviews should be conducted objectively. There shall be no personal criticism of the author. Reviewers should express their views clearly with supporting arguments.',
    'ethiqueReconnaissance'=>'Acknowledgement of Sources.',
    'ethiqueParagraphe-18'=>'Reviewers should identify relevant published work that has not been cited by the authors. Any statement that had been previously reported elsewhere should be accompanied by the relevant citation. A reviewer should also call to the chief editor\'s attention any substantial similarity or overlap between the manuscript under consideration and any other published paper of which they have personal knowledge.',
    'ethiqueConflit'=>'Conflict of Interest.',
    'ethiqueParagraphe-19'=>'Reviewers should decline to review manuscripts in which they have conflicts of interest resulting from competitive, collaborative, or other relationships or connections with any of the authors.',
    'ethiqueEditeur'=>'For Editors',
    'ethiqueDecision'=>'Decision on the Publication of Articles.',
    'ethiqueParagraphe-20'=>'The editors of Hesperis-Tamuda are responsible for deciding which of the articles submitted to the journal should be published. The editors may be guided by the policies of the journal\'s editorial board subjected to such legal requirements regarding libel, copyright infringement and plagiarism. The editors may consult with reviewers in making this decision. Even in cases where peer reviews are positive, the editors may decline to publish the paper or provide the author with further comments on how to modify the article. Should the final version not convince the editors, its publication may still be rejected. The final decision about the publication lies with the editors.',
    'ethiqueFrancJeu'=>'Fair Play.',
    'ethiqueParagraphe-21'=>'Manuscripts shall be evaluated solely on their intellectual merit.',
    'ethiqueParagraphe-22'=>'The editors and any editorial staff must not disclose any information about a submitted manuscript to anyone other than the corresponding author, reviewers, potential reviewers, other editorial advisers, and the publisher.',
    'ethiqueParagraphe-23'=>'Unpublished materials disclosed in a submitted manuscript must not be used by anyone who has a view of the manuscript while handling it in his or her own research without the express written consent of the author.',
