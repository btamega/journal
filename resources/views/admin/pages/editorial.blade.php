                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <a href="#collapseCardExample" class="d-block card-header py-3"
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Page du comité éditorial</h6>
                                </a>
                                <div class="card-body">
                                    <div class="container">
                                        <form class="user" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                <textarea name="homeText" id="summernote" cols="40" rows="10" style="width: 100%"></textarea>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-2">
                                                    <button type="button" class="btn btn-primary btn-user btn-block">Ajouter</button>
                                                </div>
                                                <div class="col-lg-2">
                                                    <button type="button" class="btn btn-google btn-user btn-block">Annuler</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
