                            ...
                            <div class="card mb-4">
                                ...
                                <form class="user" action="/createArticle" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <input type="text" style="padding: 2.3rem" class="form-control form-control-user" name="titreArticle"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select multiple="multiple" class="form-select" name="auteurs[]">
                                                    ...
                                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>{{$item->Nom.' '.$item->numero.' '.$item->Année}}</td>
                                                                @foreach($fascicules as $fascicule)
                                                                    @if($fascicule->id_fascicule==$item->id_fascicule)
                                                                        <td>
                                                                            {{$fascicule->Titre.' '.$fascicule->Nom_fascicule}}
                                                                        </td>
                                                                    @endif
                                                                @endforeach
                                                            </tr>
