            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{URL::to('/admin/home')}}">{{__('messages.accueil')}}</a>
                        <a class="collapse-item" href="{{URL::to('/admin/about')}}">{{__('messages.a_propos')}}</a>
                        <a class="collapse-item" href="{{URL::to('/admin/editorialComittee')}}">{{__('messages.comiteEditorial')}}</a>
                        <a class="collapse-item" href="{{URL::to('/admin/recommandation')}}">{{__('messages.recommandation')}}</a>
                        <a class="collapse-item" href="{{URL::to('/admin/archive')}}">{{__('messages.archive')}}</a>
                        <a class="collapse-item" href="{{URL::to('/admin/contact')}}">{{__('messages.contact')}}</a>
                        <div class="collapse-divider"></div>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{URL::to('/admin/sommaires')}}">
                    <i class="fas fa-list"></i>
                    <span>SOMMAIRES</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{URL::to('/admin/auteurs')}}">
                    <i class="fas fa-user-edit"></i>
                    <span>AUTEURS</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{URL::to('/admin/allAdmin')}}">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">{{$message->Nom}}</h6>
                                </div>
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                        src="{{asset("images/dashboard/undraw_profile.svg")}}" alt="...">
                                    </div>
                                    <p>{{$message->Message}}</p>
                                    <h6 style="color: blue">Date d'envoi : <small>{{$message->created_at}}</small></h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 mb-4">
