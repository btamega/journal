...
<html lang="en">
  <head>
    ...
    <title>Auteurs du journal</title>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                        @if (session('auteurAdded'))
                        <div class="alert alert-success">
                            {{ session('auteurAdded') }}
                        </div>
                        @elseif(session('auteurExist'))
                        ...
                        @endif
                        <form class="user" action="/createAuteur" method="POST">
                            @csrf
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    <input type="text" class="form-control form-control-user" name="statut"
                                        placeholder="dir.">
                                        <small id="emailHelp" class="form-text text-muted">Statut</small>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-6">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"
                            ...
                            <h6 class="m-0 font-weight-bold text-primary">Associer les articles aux auteurs</h6>
                        </a>
