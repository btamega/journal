		...
		<div class="topnav" id="myTopnav" style="background-color:{{$backColor->value}}">
			...
			<div class="dropdown1">
				...
				<div class="dropdown1-content">
					<a style="text-align: left" href="{{URL::to('/recommandation')}}">{{__('messages.recommandation')}}</a>
					<a href="{{URL::to('/recommandation/ethiques')}}">{{__('messages.titreEthique')}}</a>
				</div>
			</div> 
			<div class="dropdown1">
				...
				<div class="dropdown1-content">
					...
					<a href="{{URL::to('/archives-2010-2019')}}" >Hespéris-Tamuda (2010-2019)</a>
					<a href="{{URL::to('/archives_2009_2000')}}" >Hespéris-Tamuda (2000-2009)</a>
					<a href="{{URL::to('/archives_1999_1990')}}" >Hespéris-Tamuda (1990-1999)</a>
					<a href="{{URL::to('/archives_1989_1980')}}" >Hespéris-Tamuda (1980-1989)</a>
					<a href="{{URL::to('/archives_1979_1970')}}" >Hespéris-Tamuda (1970-1979)</a>
					<a href="{{URL::to('/archives_1969_1960')}}" >Hespéris-Tamuda (1960-1969)</a>
					<a href="{{URL::to('/archives_1959_1950')}}" >Hespéris (1950-1959)</a>
					<a href="{{URL::to('/archives_1949_1940')}}" >Hespéris (1940-1949)</a>
					<a href="{{URL::to('/archives_1939_1930')}}" >Hespéris (1930-1939)</a>
					<a href="{{URL::to('/archives_1929_1921')}}" >Hespéris (1921-1929)</a>
				</div>
			</div> 
			<div class="dropdown1">
